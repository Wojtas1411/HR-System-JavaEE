...
<html>
    <head>
        ...
        <title>Create EngagementEntity</title>
    </head>
    <body>
        <f:view>
            <h:messages errorStyle="color: red" infoStyle="color: green" layout="table"/>
            <h1>Create EngagementEntity</h1>
            <h:form>
                <h:panelGrid columns="2">
                                                            <h:outputText value="id:"/>
                                                    <h:inputText value="#{engagementEntity.entity.id}" title="id" />
                ...
                <h:commandButton action="#{engagementEntity.create}" value="Save" />
                <h:commandButton action="engagementEntityList" value="Cancel"/>
                <br>
            </h:form>
        </f:view>
    </body>
